...
if(isset($_GET['getSocietes'])){
	...
	// Déclaration et instanciation d'un nouveau SoapClient visant l'adresse "http://localhost:2773/WsGestionAffectations.asmx?WSDM"
	$obj = new SoapClient("http://localhost:2773/WsGestionAffectations.asmx?WSDL");
